...
bool ImGui::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    window->DrawList->AddRect(ImVec2(bb.Min.x, bb.Min.y + 10), ImVec2(bb.Max), ImColor(5, 5, 5, 255), 0, 0, 2);
    window->DrawList->AddRectFilled(ImVec2(bb.Min.x + 15, bb.Min.y + 8), ImVec2(bb.Min.x + 15 + label_size.x + 8, bb.Min.y + 12), ImColor(18, 18, 18, 255));

    ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(255 / 255.f, 255 / 255.f, 255 / 255.f, 255 / 255.f));
    RenderText(ImVec2(bb.Min.x + 20, bb.Min.y + 0), name);
    ImGui::PopStyleColor();
